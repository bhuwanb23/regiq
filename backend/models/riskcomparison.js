...
module.exports = (sequelize, DataTypes) => {
  class RiskComparison extends Model {
    /**
  ...
  RiskComparison.init({
    ...
    simulationsCompared: DataTypes.JSON,
    scenariosCompared: DataTypes.JSON,
    metricsCompared: DataTypes.JSON,
    comparisonType: DataTypes.STRING,
    timeRange: DataTypes.JSON,
    baselineSimulationId: DataTypes.UUID,
